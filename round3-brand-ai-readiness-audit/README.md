...
<!-- INVENTORY:AUTO -->
**61 checks** across six audit skills (44 discoverability, 17 engagement).

- Dependency tier: **58 CORE** (Python standard library only), **3 ENRICHMENT** (cannot fire without an optional dependency).
- By stage: reach 18, read 5, extract 14, trust 7, act 17.
- By skill: answerability-audit 8, crawl-access-audit 18, engagement-audit 17, render-gap-audit 5, structured-data-audit 6, trust-freshness-audit 7.
