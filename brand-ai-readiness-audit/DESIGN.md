...
**Brand AI-Readiness Audit** — the reasoning behind the marketplace: why it is
shaped this way, what each check does and does not fire on, how the guardrails
are enforced, and where it is still imperfect.

For what each skill does and how the entrypoint composes them, see
[README.md](README.md). This file is everything that did not belong in a short
one.

---

## The highest-value check, and why it is off by default
...
## Why two skills emit no findings
