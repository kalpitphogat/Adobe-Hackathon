...
**F-003 · MEDIUM** — Nothing near the top of the page states plainly what Priya Raman is — on /blog/measuring-pipeline-latency
...
**F-004 · MEDIUM** — Nothing near the top of the page states plainly what Northwind Analytics is — on /docs/getting-started
...
**F-005 · MEDIUM** — Nothing near the top of the page states plainly what Northwind Analytics Team is — on /pricing
