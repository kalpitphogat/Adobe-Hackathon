...
**F-002 · HIGH** — The first screen never says who this is for or what it does — on the homepage
...
**F-003 · HIGH** — The first screen never says who this is for or what it does — on /services
...
**F-009 · MEDIUM** — The main action is labelled 'Learn more', which names no outcome — on the homepage
...
**F-010 · MEDIUM** — The main action is labelled 'Submit', which names no outcome — on /services
...
- **F-004** · medium · The page title is 'Home', which does not say what the page is about — on the homepage — blocked by F-001 (`extract.ans.title_not_entity_bearing`)
- **F-005** · medium · The page title is 'Contact', which does not say what the page is about — on /contact — blocked by F-001 (`extract.ans.title_not_entity_bearing`)
- **F-006** · medium · The page title is 'Services', which does not say what the page is about — on /services — blocked by F-001 (`extract.ans.title_not_entity_bearing`)
- **F-007** · medium · The page title is 'Team', which does not say what the page is about — on /team — blocked by F-001 (`extract.ans.title_not_entity_bearing`)
...
- **F-015** · medium · A home page carries only 48 words — on the homepage — blocked by F-001 (`extract.ans.thin_content_for_page_type`)
- **F-016** · medium · A contact page carries only 17 words — on /contact — blocked by F-001 (`extract.ans.thin_content_for_page_type`)
- **F-017** · medium · A other page carries only 70 words — on /services — blocked by F-001 (`extract.ans.thin_content_for_page_type`)
- **F-018** · medium · A about page carries only 8 words — on /team — blocked by F-001 (`extract.ans.thin_content_for_page_type`)
