...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument(
        ...
        help="permit seeds and redirects that resolve to private, loopback or "
             "link-local addresses. Off by default: auditing a public brand never "
             "needs to reach internal address space. Use only for a site you host.",
    )
    p.add_argument(
        "--probe-bot-ua",
        action="store_true",
